...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, setCookie, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, getRouterParam, readBody, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/@vue+shared@3.5.18/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/vue-bundle-renderer@2.1.2/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/node-mock-http@1.0.1/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/unstorage@1.16.1_@netlify+blobs@9.1.2_db0@0.3.2_ioredis@5.6.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/unstorage@1.16.1_@netlify+blobs@9.1.2_db0@0.3.2_ioredis@5.6.1/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/youch@4.1.0-beta.8/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/devalue@5.1.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/vue@3.5.18_typescript@5.8.3/node_modules/vue/index.mjs';
import { createPathIndexLanguageParser, parseAcceptLanguage } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/@intlify+utils@0.13.0/node_modules/@intlify/utils/dist/index.mjs';
import { parse } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/cookie-es@2.0.0/node_modules/cookie-es/dist/index.mjs';
import { createRouterMatcher } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/vue-router@4.5.1_vue@3.5.18_typescript@5.8.3_/node_modules/vue-router/dist/vue-router.node.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/@iconify+utils@2.3.0/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/unhead@2.0.12/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/vue@3.5.18_typescript@5.8.3/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/unhead@2.0.12/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/db0@0.3.2/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/node_modules/.pnpm/ipx@2.1.1_@netlify+blobs@9.1.2_db0@0.3.2_ioredis@5.6.1/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/public"
      ]
    },
    "http": {
      "domains": []
...
const _GAlPHWKn2937bN_kbuTUVK651YypMddZtY6L2zgRpA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/tjian/Workspace/workspaceForNode/nuxt3-template-t4";
...
const _cRxMccyolTuPBZGXbcohptox0uDIcRQQZrCjpyDzt4 = (nitroApp) => {
...
const _jRHiDeVS3IpNMmmDJVtXgFm0ntUeI8MNefb0OoJrhe0 = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _20FA0FWTLOHU5Pons_4l4cS6bLA3rpy6tc8fTxsZ6U = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _GAlPHWKn2937bN_kbuTUVK651YypMddZtY6L2zgRpA,
_cRxMccyolTuPBZGXbcohptox0uDIcRQQZrCjpyDzt4,
_jRHiDeVS3IpNMmmDJVtXgFm0ntUeI8MNefb0OoJrhe0,
_20FA0FWTLOHU5Pons_4l4cS6bLA3rpy6tc8fTxsZ6U
];
...
const _R_R717 = eventHandler((event) => {
...
const _s5XYAr = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _jf8h35 = _messagesHandler ;
...
const getServerEntry = () => import('file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _CsTL6L = eventHandler(async (event) => {
  ...
  return await import('file:///home/tjian/Workspace/workspaceForNode/nuxt3-template-t4/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _8K_fSs = eventHandler(async (event) => {
...
const _c9fxvo = lazyEventHandler(() => {
...
const _lazy_Wc9CY1 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _R_R717, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Wc9CY1, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _s5XYAr, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:locale/messages.json', handler: _jf8h35, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _CsTL6L, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _8K_fSs, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _c9fxvo, lazy: false, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_Wc9CY1, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Wc9CY1, lazy: true, middleware: false, method: undefined }
];
