      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="space-y-8">
          <div v-if="data.info.address" class="flex items-start">
            <Icon name="heroicons:map-pin" class="h-6 w-6 text-primary-600 mt-1 mr-4" />
            <div>
          ...
          <div v-if="data.info.phone" class="flex items-start">
            <Icon name="heroicons:phone" class="h-6 w-6 text-primary-600 mt-1 mr-4" />
            <div>
          ...
          <div v-if="data.info.email" class="flex items-start">
            <Icon name="heroicons:envelope" class="h-6 w-6 text-primary-600 mt-1 mr-4" />
            <div>
